...
const destinations = [
  {
    name: "云南·大理洱海",
    description: "风花雪月，苍山洱海间的诗意生活，文艺青年必去",
    image:
...
const testimonials = [
  {
    ...
    rating: 5,
    comment:
      "TravelSync让我的日本之旅变得完美无缺！AI推荐的景点都非常棒，省去了大量的规划时间。",
  },
  {
    name: "李美丽",
    avatar:
    ...
    rating: 5,
    comment:
      "和朋友一起用这个平台规划欧洲游，实时协作功能太方便了！每个人都能参与进来。",
  },
  {
    name: "王大伟",
    avatar:
